		...
		<div class="tpl-page-container tpl-page-header-fixed">
			...
			<div class="tpl-content-wrapper">
				...
				<div class="tpl-portlet-components">
					<div class="tpl-block">
					<form action="huodong_list.action" method="post" id="sform">
									...
									<table
										...
										<s:iterator value="list" status="st">
											<tr>
												...
												<td><img src="<%=Const.ROOT %><s:property value="pic"/>" style="max-width:60px;"/></td>
												
												<td><s:property value="htime"/></td>
												<td><s:property value="baomings.size()"/></td>
												
												<td>
													<div class="am-btn-toolbar">
														<div class="am-btn-group am-btn-group-xs">
																<button
																	class="am-btn am-btn-default am-btn-xs am-text-secondary" type="button" onclick="toShow('<s:property value="id"/>')">
																	<span class="am-icon-trash-o"></span> 参与人员
																</button>
																<button
...
<!-- 新增对话框begin -->
		<div class="am-modal am-modal-no-btn" tabindex="-1" id="add-modal">
			<div class="am-modal-dialog">
				...
				<div class="am-modal-bd">
					<!-- 新增表单开始 -->
					<form class="am-form" name="addForm" action="huodong_add.action" method="post"
						...
						<div class="am-g" style="margin-top: 4px;">
							...
							<div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
								<input type="text" id="title" name="huodong.title" class="am-input-sm">
							</div>
						</div>
						<div class="am-g" style="margin-top: 4px;">
							<div class="am-u-sm-3 am-u-md-3 am-text-right">
							...
							<div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
								<input type="text" id="htime" onclick="WdatePicker()" name="huodong.htime"/>
							</div>
						</div>
						<div class="am-g" style="margin-top: 4px;">
							<div class="am-u-sm-3 am-u-md-3 am-text-right">
							...
							<div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
                                ...
                                <input type="hidden" id="pic" name="huodong.pic" value="${huodong.pic}"/> 
								<button type="button" onclick="updateFile()">上传活动图片</button> 
							</div>
						</div>
		...
		<div class="am-modal am-modal-no-btn" tabindex="-1" id="update-modal">
			<div class="am-modal-dialog">
				...
				<div class="am-modal-bd">
					<!-- 修改表单begin -->
					<form class="am-form" name="updateForm" action="huodong_update.action"
						method="post" onsubmit="return checkUpdate()">
							<input type="hidden" name="huodong.id" id="id"/>
							<div class="am-g" style="margin-top: 4px;">
							<div class="am-u-sm-3 am-u-md-3 am-text-right">
								名称
							</div>
						...
						<div class="am-g" style="margin-top: 4px;">
							...
							<div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
                                ...
                                <input type="hidden" id="pic" name="huodong.pic"/> 
								<button type="button" onclick="updateFile2()">上传活动图片</button> 
							</div>
						</div>
						<div style="margin-top: 10px;">
							<button type="submit" class="am-btn am-btn-primary am-btn-xs">
		...
		<!-- 修改对话框begin -->
		<div class="am-modal am-modal-no-btn" tabindex="-1" id="show-modal">
			<div class="am-modal-dialog">
				<div class="am-modal-hd">
					参与活动人员列表
					<a href="javascript: void(0)" class="am-close am-close-spin"
		...
		function checkAdd(){
			...
			function toDelete(id) {
				$("#delete_modal").modal({
					...
					onConfirm: function(options) {
						//执行删除
						location.href = "huodong_delete.action?id=" + id;
					},
					onCancel: function() {
					}
				});
		          ...
		          (
		              {
		                  ...
		                  {        	
		                	  $("#add-modal #pic").val($(data).find("body").text());
		                	  alert("上传成功，请点击保存！");
		                  },
		          ...
		          (
		              {
		                  ...
		                  success: function (data, status)  //服务器成功响应处理函数
		                  {        	
		                	  $("#update-modal #pic").val($(data).find("body").text());
		                	  alert("上传成功，请点击保存！");
		                  },
		                  error: function (data, status, e)//服务器响应失败处理函数
		                  {
			...
			function toUpdate(id){
				$.getJSON("huodong_detail.action",{"id":id},function(data){
					$("#update-modal #id").val(id);
					$("#update-modal #title").val(data.title);
					$("#update-modal #htime").val(data.htime);
					$("#update-modal #pic").val(data.pic);
			...
			function toShow(id){
				$("#ulist").html("");
				$.getJSON("huodong_detail.action",{"id":id},function(data){
					$(data.baomings).each(function(index,b){
						$("#ulist").append("<li>"+(index+1)+" &nbsp; &nbsp; &nbsp; "+b.hname+"</li>");
					});
					$("#show-modal").modal({width:500,height:350});
				})
			}
